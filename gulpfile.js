...
gulp.task("rollup", function() {
	...
	.pipe(buffer())
	.pipe(rename('bdq-ion-global-nav-locker.js'))
	.pipe(gulp.dest('./dist/bundles'))
	.pipe(uglify())
	.pipe(rename('bdq-ion-global-nav-locker.min.js'))
	.pipe(gulp.dest('./dist/bundles'));
});
...
gulp.task("rollup-aot", ["rollup-ngc"], function() {
	...
	.pipe(rename('bdq-ion-global-nav-locker.aot.js'))
	.pipe(gulp.dest('./dist/bundles'))
	.pipe(uglify())
	.pipe(rename('bdq-ion-global-nav-locker.aot.min.js'))
	.pipe(gulp.dest('./dist/bundles'));
});
