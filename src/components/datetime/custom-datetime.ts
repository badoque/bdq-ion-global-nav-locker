...
import { 
  ...
  parseDate, updateDate, DateTimeData, convertDataToISO, 
  daysInMonth, dateSortValue, dateDataSortValue, LocaleData 
...
export const DATETIME_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => BdqDateTime),
  multi: true
};
...
export class BdqDateTime extends Ion implements AfterContentInit, ControlValueAccessor, OnDestroy {
  _disabled: any = false;
  _labelId: string;
  _text: string = '';
  _fn: Function;
